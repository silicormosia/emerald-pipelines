...
settings_fvcb = Emerald.Land.land_model_settings(mode = "default");
settings_fvcb["REMOVE_WHEN_DONE"] = false;

settings_j3b = Emerald.Land.land_model_settings(mode = "default");
settings_j3b["C3_MODEL"] = "J3B";
settings_j3b["CONFIG_TAG"] = "default_j3b";
